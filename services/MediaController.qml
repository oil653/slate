...
// I did NOT make this, op is outfoxxed


// Source: https://git.outfoxxed.me/outfoxxed/nixnew/ (original file name is MprisController.qml but its too long so i renamed it)
