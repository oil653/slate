...
PanelWindow{
    ...
    exclusiveZone: 0;
    color: "transparent";
    Rectangle { // The calendar is mostly vibe coded, i review and fix some stuff with it, but it should be fine
        id: calRoot;
        anchors.fill: parent;
        radius: 10;
        ...
        Item { // Header with nav
            ...
            Item { // -1 month
                ...
                MouseArea {
                    anchors.fill: parent;
                    onClicked: {
                        if (calRoot.displayedMonth === 0) {
                            calRoot.displayedMonth = 11
                            calRoot.displayedYear -= 1
                        } else {
                            calRoot.displayedMonth -= 1
                        }
                    }
                }
                IconImage{
            ...
            Text {
                id: currentMonth;
                anchors.centerIn: parent;
                text: calRoot.monthNames[calRoot.displayedMonth] + " " + calRoot.displayedYear
                color: Colors.text;
                font.pixelSize: 18
                font.bold: true;
            ...
            Item { // +1 month
                ...
                MouseArea {
                    anchors.fill: parent;
                    onClicked: {
                        if (calRoot.displayedMonth === 11) {
                            calRoot.displayedMonth = 0
                            calRoot.displayedYear += 1
                        } else {
                            calRoot.displayedMonth += 1
                        }
        ...
        Grid {
            ...
            property int firstDayOfMonth: {
                ...
                var d = new Date(calRoot.displayedYear, calRoot.displayedMonth, 1)
                var day = d.getDay()
                return (day + 6) % 7 // shift so Monday=0
            }
            property int daysInMonth: {
                var d = new Date(calRoot.displayedYear, calRoot.displayedMonth + 1, 0)
                return d.getDate()
            }
            property int prevMonthDays: {
                var d = new Date(calRoot.displayedYear, calRoot.displayedMonth, 0)
                return d.getDate()
            }
                ...
                Rectangle {
                    ...
                    color: {
                        ...
                        if (index < calendarGrid.firstDayOfMonth) {
                            "transparent"
                        } else if (cellDay === calRoot.today.getDate()
                                && calRoot.displayedMonth === calRoot.today.getMonth()
                                && calRoot.displayedYear === calRoot.today.getFullYear()) {
                            Colors.background
                        } else {
                            "transparent"
                        }
                    ...
                    Text {
                        ...
                        color: {
                            if (index < calendarGrid.firstDayOfMonth) {
                                Colors.text2
                            } else if (index - calendarGrid.firstDayOfMonth + 1 === calRoot.today.getDate()
                                && calRoot.displayedMonth === calRoot.today.getMonth()
                                && calRoot.displayedYear === calRoot.today.getFullYear()) {
                                Colors.text
                            } else {
